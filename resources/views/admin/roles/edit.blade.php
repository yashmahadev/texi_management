            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-3">
                    <div class="form-check card p-2">
                        <input class="form-check-input ms-0" type="checkbox" name="permissions[]" value="{{ $permission->id }}" id="perm_{{ $permission->id }}" {{ in_array($permission->id, $rolePermissions) ? 'checked' : '' }}>
