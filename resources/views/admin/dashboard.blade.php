                        ...
                        <tr>
                            <td>
                                ...
                                @elseif($log->directBooking)
                                    {{ $log->directBooking->vehicle->vehicle_number ?? 'Unassigned' }}
                                @else
                                    -
                                @endif
                            </td>
                            ...
                            <td>
                                @if($log->monthlyDuty)
                                    {{ \Carbon\Carbon::parse($log->monthlyDuty->expected_start_time)->format('h:i A') }}
                                @elseif($log->directBooking)
                                    {{ $log->directBooking->booking_datetime->format('h:i A') }}
                                @else
                                    -
                                @endif
                            </td>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0 border-top">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="text-center py-4">No duties scheduled for tomorrow.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
